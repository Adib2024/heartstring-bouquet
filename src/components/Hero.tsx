...
const Hero: React.FC = () => {
  ...
  const content = {
    th: {
      ...
      description: 'นี่คือพื้นที่ที่อุทิศให้กับเรา — ความทรงจำของเรา ช่วงเวลาของเรา และทุกสิ่งเล็กๆ น้อยๆ ที่ทำให้เรื่องราวความรักของเราเป็นเอกลักษณ์ ทุกรายล��เอียดที่นี่ถูกสร้างขึ้นด้วยความรัก เหมือนกับชีวิตที่เรากำลังสร้างด้วยกัน',
